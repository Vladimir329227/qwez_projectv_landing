...
const ProductCarousel = () => {
  ...
  const products = [
    {
      id: 1,
      image: "/figma/e644ba8ce683ee19.png",
    ...
    {
      id: 2,
      image: "/figma/41f09a12ce3df0c8.png",
    ...
    {
      id: 3,
      image: "/figma/fa3a509ea023e355.png",
      title: "Visible & tangible results",
    ...
    },
    {
        ...
        ingredients: [
          { name: "Grape seed extract", amount: "80 mg" },
          { name: "including polyphenols", amount: "76 mg" },
          { name: "Beta-carotene", amount: "5 mg" },
          { name: "Selenium", amount: "50 mcg" }
        ]
      },
      {
        id: 5,
    ...
    <div className="w-full max-w-7xl mx-auto px-1 sm:px-2 py-16">
      ...
      <div className="relative overflow-hidden mb-6" ref={containerRef}>
        ...
        <div 
          ...
          style={{ 
            gap: `${getGap()}px`,
            width: `calc(${(products.length * 100) / cardsToShow}% + ${getGap() * (products.length - 1)}px)`,
            marginBottom: `15px`
          }}
        >
          {products.map((product) => (
            <div 
              ...
              style={{ 
                width: `calc(${100 / products.length}% - ${getGap() * (products.length - 1) / products.length}px)`
              }}
            >
              {/* Карточка товара с адаптивными размерами */}
              <div className="flex flex-col bg-[#F6F6F6] rounded-2xl h-full w-full max-w-[280px] sm:max-w-[300px] lg:max-w-[320px] overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                {/* Контейнер для картинки с адаптивными размерами */}
                <div className="w-full h-48 sm:h-56 lg:h-64 p-2 sm:p-3 pb-0 flex items-center justify-center">
                  <img
                    src={product.image}
