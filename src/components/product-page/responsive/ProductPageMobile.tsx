      ...
      <div className="bg-white w-full -mt-12 relative z-10 rounded-t-3xl shadow-lg overflow-hidden">
        <div className="self-stretch">
          <div className="flex flex-col items-center self-stretch pt-5 pb-[63px] px-5 gap-2 max-w-md mx-auto">
            ...
            <div className="flex flex-col items-start self-stretch bg-white py-4 mb-6 gap-3 rounded-xl border border-solid border-[#E1E9FD]">
              ...
              <div className="flex flex-col gap-1 w-full px-4">
                {allIngredients.map((ingredient, index) => (
                  <div key={index} className="flex justify-between items-center py-1">
                    ...
                    <span className="text-[#1F2429] text-xs font-medium">
                      {ingredient.amount}
                    </span>
                  </div>
                ))}
