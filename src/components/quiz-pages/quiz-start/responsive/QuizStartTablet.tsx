      ...
      <div className="flex flex-col w-[420px] mr-8 flex-shrink-0 z-10 pl-8 h-full overflow-hidden">
        ...
        >
          ...
          <button
            ...
            onClick={onNext}
          >
            <span className="text-white text-[20px]">Next</span>
          </button>
          <button
            className="flex flex-col items-center bg-white text-center w-full max-w-[350px] py-5 rounded-[100000px] border-[3px] hover:bg-white transition-colors"
